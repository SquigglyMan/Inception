...
wp core install --allow-root --path=/var/www/html/wordpress --url=https://llarue.42.fr --title="$WP_TITLE" --admin_user=$WP_ADMIN --admin_password=$WP_ADMIN_PASSWORD --admin_email=$WP_ADMIN_EMAIL
